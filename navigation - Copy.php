                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-2" aria-controls="submenu-1-2">Users</a>
                                        ...
                                        <li class="nav-item">
                                         ...
                                         <li class="nav-item">
                                            <a class="nav-link" href="index.php?page=Search_leads_data">Search leads</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.php?page=Search_leads_data_staff">Search leads Staff</a>
                                        </li>
                                        <li class="nav-item">
