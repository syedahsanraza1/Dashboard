...
$Searchkeytoreadleads = $_POST['Searchkeytoreadleads'];
$searchleadsby = $_POST['searchleadsby'];
...
if ($searchleadsby == 'Leadsid') {
    $displayquery = "SELECT * FROM `leads` WHERE leadsid = '$Searchkeytoreadleads' AND Userid = '$userloginid'";
}elseif ($searchleadsby == 'PNRNumber') {
   $displayquery = "SELECT * FROM leads lds INNER JOIN sucesssales sus ON lds.leadsid = sus.salesleadid WHERE sus.PNRnumbers = '$Searchkeytoreadleads' AND lds.Userid = '$userloginid'";
}elseif ($searchleadsby == 'Leadstitle') {
    $displayquery = "SELECT * FROM `leads` WHERE leadtitle = '$Searchkeytoreadleads' AND Userid = '$userloginid'";
}else{}
...
///////update submmit start
if (isset($_POST['hidden_leadss_id'])) {
    $hidden_lead_id = $_POST['hidden_lead_id'];
    $firstname = $_POST['update_firstname'];
    $lastname = $_POST['lastnameupdate'];
    $primaryphone = $_POST['primaryphoneupdate'];
    $secoundaryphone = $_POST['secoundaryphoneupdate'];
    $leadid = $_POST['leadidupdate'];
    $emailaddress = $_POST['emailaddressupdate'];
    $customertype = $_POST['customertypeupdate'];
    $servicetype = $_POST['servicetypeupdate'];
    $triptype = $_POST['triptypeupdate'];
    $departuredate = $_POST['departuredateupdate'];
    $returndate = $_POST['returndateupdate'];
    $leadsector = $_POST['leadsectorupdate'];
    $leadtitle = $_POST['leadtitleupdate'];
    $careof = $_POST['careofupdate'];
    $location = $_POST['locationupdate'];
    $icwc = $_POST['icwcupdate'];
    $createdby = $_POST['createdbyupdate'];
    $takenoverby = $_POST['takenoverbyupdate'];
    $status = $_POST['statusupdate'];
    $action = $_POST['actionupdate'];
    $webuser = $_POST['webuserupdate'];
     $airline = $_POST['airlineupdate'];
      $paxdetails = $_POST['paxdetailsupdate'];
       $freetext = $_POST['freetextupdate'];
        $date = $_POST['dateupdate'];
        $takendate = $_POST['takendateupdate'];
        $loginid = $_POST['loginidupdate'];
     



                      $queryupdate ="UPDATE `leads` SET `leadsid`='$leadid',`clientid`='$firstname$primaryphone',`leadsector`='$leadsector',`leadtitle`='$leadtitle',`Status`='$status',`Action`='$action' WHERE leadsid = '$hidden_clien_id'";
