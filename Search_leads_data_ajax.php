...
if ($searchleadsby == 'Leadsid') {
    $displayquery = "SELECT * FROM `leads` WHERE leadsid = '$Searchkeytoreadleads'";
}elseif ($searchleadsby == 'PNRNumber') {
   $displayquery = "SELECT * FROM leads lds INNER JOIN sucesssales sus ON lds.leadsid = sus.salesleadid WHERE sus.PNRnumbers = '$Searchkeytoreadleads'";
}elseif ($searchleadsby == 'Leadstitle') {
    $displayquery = "SELECT * FROM `leads` WHERE leadtitle = '$Searchkeytoreadleads'";
}else{}
