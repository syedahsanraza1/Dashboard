                                    ...
                                    <form class="needs-validation" novalidate="">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <input type="text" class="form-control" id="UniqueuserID" placeholder="Unique ID" value="" required="">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <input type="text" class="form-control" id="UniqueIDname" placeholder="Userame" value="" required="">
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate="">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="Unique ID">Unique ID</label>
                                                <input type="text" class="form-control" id="UniqueuserIDmonthwise" placeholder="Unique ID" value="" required="">
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="validationCustom02">UserName</label>
                                                <input type="text" class="form-control" id="UniqueIDnamemonthwise" placeholder="Userame" value="" required="">
                                                <div class="valid-feedback">
                                                    username
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate="">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="Unique ID">Unique ID</label>
                                                <input type="text" class="form-control" id="UniqueuserIDyearwise" placeholder="Unique ID" value="" required="">
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="validationCustom02">UserName</label>
                                                <input type="text" class="form-control" id="UniqueIDnameyearwise" placeholder="Userame" value="" required="">
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
...
//alert("Hello\nHow are you?");
                                  ...
                                  var UniqueIDnameYearyear = $('#UniqueIDnameYearyear').val();
                                   ...
                                   //alert(hidden_invoice_user_id);
                                    ...
                                    $.ajax({
                                          url: 'create_user_invoices_ajax.php',
                                          type: 'post',
